...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future uploadFile() async {
    ...
    storageTaskSnapshot.ref.getDownloadURL().then((downloadUrl) {
      ...
      print(imageUrl);
      if (widget.isAdmin) {
        _fireStore.collection('chatRooms').document(widget.userEmail).collection('chatScreen').add({
          'text': '',
        ...
        _fireStore.collection('chatRooms').document(loggedInUser.email).setData({
          'userTyping': false,
          'adminTyping': false,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: widget.isAdmin
            ...
            : Text('Contact with supporter', style: TextStyle(color: Colors.white)),
      ),
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            MessagesStream(
              ...
              userEmail: widget.isAdmin ? widget.userEmail : loggedInUser.email,
              user: loggedInUser,
            ),
            TypingStream(
