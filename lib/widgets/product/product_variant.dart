...
class BasicSelection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (type == "option") return OptionSelection(options: options, value: value, title: title, onChanged: onChanged);
      ...
      child: ListView(
        ...
        children: <Widget>[
          Center(
            ...
            constraints: new BoxConstraints(minWidth: 40),
            child: Text(
            ...
            AnimatedContainer(
              ...
              decoration: type == "color"
                  ? BoxDecoration(
                      ...
                      border: Border.all(
                          width: 1.0, color: Theme.of(context).accentColor.withOpacity(0.3)),
                    )
                  : BoxDecoration(
            ...
            for (var item in options)
              AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        width: 1.0, color: Theme.of(context).accentColor.withOpacity(0.5)),
                  ),
                  child: InkWell(
                    splashColor: Colors.transparent,
                    highlightColor: Colors.transparent,
